...
thread reflection 生成後の summary / intent embedding を投入する据え置きワークフロー群です。reflection 生成用の single / batch / prompt は `../../agent-chat-import/workflows/thread-reflection/README_ja.md` を参照してください。
