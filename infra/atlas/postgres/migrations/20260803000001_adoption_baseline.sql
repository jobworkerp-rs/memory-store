-- The adoption baseline is a complete schema snapshot for fresh PostgreSQL databases.
CREATE TABLE thread (
...
CREATE TABLE thread_reflection_index (
    ...
    origin_channel TEXT, outcome INT NOT NULL, score DOUBLE PRECISION NOT NULL,
    score_self DOUBLE PRECISION NOT NULL, score_heuristic DOUBLE PRECISION NOT NULL,
    ...
    pinned BOOLEAN NOT NULL DEFAULT FALSE, is_recurrence BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE reflection_failure_mode (memory_id BIGINT NOT NULL, mode VARCHAR(64) NOT NULL, PRIMARY KEY (memory_id, mode));
CREATE INDEX rfm_mode ON reflection_failure_mode (mode);
CREATE TABLE reflection_tool (memory_id BIGINT NOT NULL, tool VARCHAR(128) NOT NULL, PRIMARY KEY (memory_id, tool));
...
CREATE TABLE reflection_fact (
    ...
    fact_kind INT NOT NULL, turn_index INT NOT NULL DEFAULT 0,
    weight DOUBLE PRECISION, note TEXT, links_json JSONB,
...
CREATE TABLE failure_signature_indicator_norm (
    ...
    max_value DOUBLE PRECISION NOT NULL, weight DOUBLE PRECISION NOT NULL DEFAULT 1.0
);
