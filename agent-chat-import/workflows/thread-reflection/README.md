...
memories のチャットスレッドから LLM reflection を生成する generation 系ワークフローです。embedding 再投入と dispatcher 自動登録は `../../../workflows/thread-reflection/README.md` が担当します。
...
- embedding / model 切替運用: `../../../workflows/thread-reflection/README.md`
