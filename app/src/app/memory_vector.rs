...
///
/// Unset semantics (see `docs/improve-search-spec.md` §P1):
...
/// and `docs/improve-search-spec.md` §P5 for the design rationale.
...
impl MemoryVectorAppImpl {
    ...
    /// is a follow-up PR. See `docs/improve-search-spec.md` §P5
    /// 「経路ごとに **異なる回避策** が必要」.
...
///    contract documented in `docs/improve-search-spec.md` §P1
///    "orphan thread の取り扱い".
